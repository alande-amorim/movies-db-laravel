        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="mt-8 md:ml-24 md:mt-0">
                ...
                <div class="flex items-center flex-wrap text-gray-400 text-sm">
                    ...
                    <span class="mx-2">|</span>
                    <span class="text-gray-400 text-sm">{!! $tvshow['genres'] !!}</span>
                </div>
                ...
                <div x-data="{ isOpen:false }">
                    @if($tvshow['videos']['results'] > 0)
                        <div class="mt-12">
                            <button
                                @click="isOpen = true"
                                class="{{ $tvshow['videos'] ? '' : 'opacity-50 cursor-not-allowed' }} flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                            >
