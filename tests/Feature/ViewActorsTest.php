...
{
    public function testActorsIndexPage()
    {
        Http::fake([
        ...
        $response->assertSee('Suicide Squad');
        $response->assertSee('I am Legend');

        $response->assertSee('Robert Downey Jr.');
        $response->assertSee('The Avengers');
        $response->assertSee('Iron Man');
        $response->assertSee('Avengers: Infinity War');
    }

    public function testActorsIndexPage2()
    {
        Http::fake([
        ...
        $response->assertSee('Independence Day 2');
        $response->assertSee('Suicide Squad 2');
        $response->assertSee('I am Legend 2');

        $response->assertSee('Robert Downey Jr. 2');
        $response->assertSee('The Avengers 2');
        $response->assertSee('Iron Man 2');
        $response->assertSee('Avengers: Infinity War 2');
    }

    public function testActorShowPage()
    {
        Http::fake([
